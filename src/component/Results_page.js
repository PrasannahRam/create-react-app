  ...
  return (
    <div>
      <div>
        ...
        <select  value={exam} onChange={(e) => setexam(e.target.value)} style={{ width: 200, padding: '10px', margin: '10px', borderRadius: '5px' }}>
          <option value="O/L">O/L</option>
          <option value="A/L">A/L</option>
        </select>
        <select value={year} onChange={(e) => setyear(e.target.value)} style={{ width: 300, padding: '10px', margin: '10px', borderRadius: '5px' }}>
